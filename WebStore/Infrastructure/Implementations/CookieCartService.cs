...
namespace WebStore.Infrastructure.Implementations.Cart
{
    public class CookieCartService : ICartService
    {
        ...
        private Models.Cart.Cart Cart
        {
            get
            {
                ...
                Models.Cart.Cart cart = null;

                if (cookie == null)
                {
                    cart = new Models.Cart.Cart { Items = new List<CartItem>() };
                ...
                json = cookie;
                cart = JsonConvert.DeserializeObject<Models.Cart.Cart>(json);
